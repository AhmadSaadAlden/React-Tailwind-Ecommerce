...
const Banner = ({data}) => {
  return (
    <div className='py-12 min-h-[550px] flex justify-center items-center'>
        <div className='container'>
            <div 
                ...
                {/* Second col */}
                <div data-aos= "zoom-out" className='h-full flex items-center'>
                ...
                <div className='felx flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos= "fade-up" data-aos-offset="0">
                        ...
                        className='bg-white rounded-full my-2 py-2 px-4'> Shop Now</button>
                    </div>
                </div>
            </div>
        </div>
